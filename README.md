...
- Bổ sung lệnh Server Connection để kết nối làm việc nhóm qua mạng LAN hoặc internet.
- Bổ sung lệnh Disconnect để ngắt kết nối làm việc nhóm qua mạng LAN hoặc internet.
- Bổ sung lệnh Send Format để gửi định dạng khi làm việc nhóm qua mạng LAN hoặc internet.
- Bổ sung lệnh Administrator để thiết lập quyền của người dùng.
- Bổ sung lệnh Visio to PDF để chuyển đổi Visio sang PDF hàng loạt (yêu cầu máy cài Visio)
- Bổ sung lệnh Management PDF để quản lý và sắp xếp các trang trong file PDF. Thay thế cho 2 lệnh Combine Selected PDFs và Extract PDF Pages.
- Bổ sung lệnh Read PDF để đọc file PDF
- Cải tiến lệnh Navigation để Quản lý Workbook - Sheet.
- Cải tiến lệnh Rebar Cut Optimizer để Cắt thép thép ưu.
